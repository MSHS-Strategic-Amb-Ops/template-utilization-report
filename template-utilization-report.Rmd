...
slot_util_month <- slot_view_tbl %>%
  ...
  group_by(CAMPUS, DEPT_SPECIALTY_NAME, DEPARTMENT, PROV_ID, PROVIDER, SLOT_MONTH_YEAR, APPT_WEEK) %>%
  summarise(avail_hours = sum(AVAILABLE_HOURS, na.rm = T),
            sched_hours = sum(SCHEDULED_HOURS, na.rm = T),
            arrived_hours = sum(ARRIVED_HOURS, na.rm = T)) %>%
  group_by(CAMPUS, DEPT_SPECIALTY_NAME, DEPARTMENT, PROV_ID, PROVIDER, SLOT_MONTH_YEAR) %>%
...
slot_util_day <- slot_view_tbl %>%
  ...
  summarise(avail_hours_day = sum(AVAILABLE_HOURS, na.rm = T),
            sched_hours_day = sum(SCHEDULED_HOURS, na.rm = T),
            arrived_hours_day = sum(ARRIVED_HOURS, na.rm = T),
...
slot_util_summary <- slot_util_summary %>%
  dplyr::select(CAMPUS, DEPT_SPECIALTY_NAME, DEPARTMENT, PROVIDER, PROV_TYPE, SLOT_MONTH_YEAR,
...
reactable(
  ...
  groupBy = c("MSHS", "CAMPUS", "DEPT_SPECIALTY_NAME", "DEPARTMENT", "PROVIDER", "PROV_TYPE", "SLOT_MONTH_YEAR"),
  ...
  columnGroups = list(
    ...
    colGroup(name = "", 
             columns = c("MSHS", "CAMPUS", "DEPT_SPECIALTY_NAME", "DEPARTMENT", "PROVIDER", "PROV_TYPE", "SLOT_MONTH_YEAR"), sticky = "left", 
...
reactable(
  ...
  groupBy = c("MSHS", "CAMPUS", "DEPT_SPECIALTY_NAME", "DEPARTMENT", "PROV_TYPE", "PROVIDER", "SLOT_MONTH_YEAR"),
  ...
  columnGroups = list(
    ...
    #          headerStyle = list(color = "#d80b8c", fontSize = "16px"))
    colGroup(name = "", 
             columns = c("MSHS", "CAMPUS", "DEPT_SPECIALTY_NAME", "DEPARTMENT", "PROV_TYPE", "PROVIDER", "SLOT_MONTH_YEAR"), sticky = "left", 
             headerStyle = list(fontSize = "16px")),
    colGroup(name = "Available Hours", 
             columns = c("avail_hours","avail_hours_week"),
             headerStyle = list(color = "#7f7f7f", fontSize = "16px")),
