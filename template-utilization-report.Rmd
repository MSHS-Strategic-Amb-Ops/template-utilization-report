...
#       tags$option("None", value = c("MSHS","CAMPUS","DEPT_SPECIALTY_NAME","DEPARTMENT","PROVIDER","SLOT_MONTH_YEAR")),
...
#       lapply(c("MSHS","CAMPUS","DEPT_SPECIALTY_NAME","DEPARTMENT","PROVIDER","SLOT_MONTH_YEAR"), tags$option)
#     ),
# 
...
reactable(
  ...
  groupBy = c("CAMPUS", "DEPT_SPECIALTY_NAME", "DEPARTMENT", "PROVIDER",
