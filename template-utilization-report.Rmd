...
# slot_view_tbl <- tbl(conn1, in_schema("OAO_PRODUCTION", "AMBULATORY_SLOT_TABLE"))
...
htmltools::browsable(
  tagList(
    tags$button(
      ...
      onclick = "Reactable.downloadDataCSV('template-util-table', 'Template Utilization')"
    ),
...
reactable(
  ...
  groupBy = c("MSHS", "CAMPUS", "CAMPUS_SPECIALTY", "DEPARTMENT", "PROVIDER", "PROV_TYPE", "SLOT_MONTH_YEAR"),
...
htmltools::browsable(
  tagList(
    tags$button(
      tagList(fontawesome::fa("download"), "Download Table"),
      onclick = "Reactable.downloadDataCSV('template-util-all-table', 'Template Utilization')"
    ),
...
reactable(
  ...
  groupBy = c("MSHS", "CAMPUS", "CAMPUS_SPECIALTY", "DEPARTMENT", "PROV_TYPE", "PROVIDER", "SLOT_MONTH_YEAR"),
