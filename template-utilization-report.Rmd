...
slot_util_summary <- slot_util_summary %>%
  dplyr::select(CAMPUS, CAMPUS_SPECIALTY, DEPARTMENT, DEPARTMENT_ID, PROVIDER, PROV_TYPE, PROV_SPECIALTY, SLOT_MONTH_YEAR,
...
reactable(
  slot_util_summary %>%
    ...
    dplyr::select(MSHS, CAMPUS, CAMPUS_SPECIALTY, DEPARTMENT, DEPARTMENT_ID, PROVIDER, PROV_TYPE, PROV_SPECIALTY, SLOT_MONTH_YEAR,
                avail_hours, avail_hours_week, sched_hours, arrived_hours, 
                sched_util, prov_util,
                avail_hours_day_MON, avail_hours_day_TUE, avail_hours_day_WED, avail_hours_day_THU, avail_hours_day_FRI,
                avail_hours_day_SAT,
